...
const RESOURCE_SPECS: &[ResourceSpec] = &[
    ...
    ResourceSpec {
        name: "personas",
        commands: &["context", "list", "get", "create", "update", "delete", "phone-numbers"],
        description: "Personas define simulated users, voices, languages, and behavior for evaluations.",
        id_name: "persona_id",
        id_format: "22-character Coval ID",
        requires: &[],
        ...
        pitfalls: &["Voice and language choices affect run behavior and audio output."],
    },
    ResourceSpec {
        name: "metrics",
        commands: &["context", "list", "get", "create", "update", "delete"],
