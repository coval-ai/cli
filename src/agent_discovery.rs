...
const RESOURCE_SPECS: &[ResourceSpec] = &[
    ...
    ResourceSpec {
        ...
        description: "Uploaded conversations are production interactions submitted through the UI, API, SDK, or an integration and evaluated with metrics.",
        id_name: "conversation_id",
        id_format: "Conversation ID returned by Coval",
        requires: &[],
        optional: &["agents", "metrics"],
        produces: &["metric outputs"],
        related: &["simulated-conversations", "metrics", "agents"],
        workflows: &[WorkflowSpec {
            name: "Inspect recent uploaded conversations",
            argv: &["uploaded-conversations", "list"],
        }],
    ...
    ResourceSpec {
        ...
        produces: &["simulated conversations", "metric outputs"],
        related: &["simulated-conversations", "agents", "personas", "test-sets"],
        workflows: &[WorkflowSpec {
            name: "Launch a run",
            argv: &[
                "runs",
    ...
    ResourceSpec {
        ...
        description: "Simulated conversations are individual run outputs for one test case and persona interaction.",
        id_name: "simulation_id",
        id_format: "Simulation ID returned by Coval",
        requires: &["runs"],
        optional: &["metrics"],
        produces: &["audio URLs", "metric outputs"],
        related: &["runs", "uploaded-conversations", "metrics"],
        workflows: &[WorkflowSpec {
            name: "List simulated conversations for a run",
            argv: &[
    ...
    ResourceSpec {
        ...
        related: &["review-projects", "metrics", "simulated-conversations"],
        workflows: &[WorkflowSpec {
    ...
    ResourceSpec {
        ...
        description: "Traces are OpenTelemetry spans ingested for simulated and uploaded conversations.",
        id_name: "simulation_output_id",
        id_format: "Simulation output ID returned by trace search or simulation APIs",
        requires: &[],
        optional: &["agents", "test-sets", "runs", "uploaded-conversations"],
